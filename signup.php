...
if ($_POST) {
  ...
  if (mysqli_num_rows($result) == 0) {
    ...
    $sql = "INSERT INTO users (fullname,username, address, age, gender, email, password) VALUES ('$fullname','$username', '$address', '$age', '$gender', '$email', '$hash')";
...
<body>
  <nav>
    ...
    <ul>
      ...
      <?php if ($_SESSION['id']) { ?>
        <li>
          <a href="login.php" class="active"><?= $_SESSION['username'] ?></a>
        </li>
      <?php } else { ?>
        <li>
